...
class ItemGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Item entity")
        ...
        .repeat(2) {
            ...
            .post("/api/items")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "orderTime":"2020-01-01T00:00:00.000Z", "arrivalTime":"2020-01-01T00:00:00.000Z", "truck":"0", "casted":null, "slump":"0", "theoreticalConcreteVolume":null}""")).asJSON
            .check(status.is(201))
