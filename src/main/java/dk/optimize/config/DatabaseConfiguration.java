...
import dk.optimize.config.liquibase.AsyncSpringLiquibase;
...
@Configuration
@EnableJpaRepositories("dk.optimize.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("dk.optimize.repository.search")
