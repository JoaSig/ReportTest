...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "documentManagement@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "documentManagement API";

        private String description = "documentManagement API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "documentManagement";
